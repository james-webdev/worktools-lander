  ...
  <header className="rounded sticky top-0 z-20 bg-white shadow">
    <div className="container flex flex-col sm:flex-row justify-between items-center mx-auto py-2 px-8">
      ...
      <div className="flex mt-4 sm:mt-0">
        <AnchorLink className="complianceblue px-4" href="#features">
          Features
        </AnchorLink>
        <AnchorLink className="complianceblue px-4" href="#pricing">
          Pricing
        </AnchorLink>
        <AnchorLink className="complianceblue px-4" href="#testimonials">
          Testimonials
        </AnchorLink>
      </div>
